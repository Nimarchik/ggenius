...
import ggenius from '../assets/pictures/Home/ggenius.jpg'
        ...
        <div className={style.homeWrapper}>
          <div className={style.homeWrapperCont}>
            ...
            <div className={style.homeWrapperContBtns}>
              ...
              <Link aria-label='link to the Discord server' to={'https://discord.gg/CsVhmUnK'} className={style.homeWrapperContBtnDs}>
