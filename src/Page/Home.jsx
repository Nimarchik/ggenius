...
import ggenius from '../assets/pictures/Home/ggenius.png'
        ...
        <div className={style.homeWrapper}>
          <div className={style.homeWrapperCont}>
            ...
            <div className={style.homeWrapperContBtns}>
              <Link to={'https://t.me/ggenius_gg'} className={style.homeWrapperContBtn}>
              ...
              <Link to={'https://discord.gg/CsVhmUnK'} className={style.homeWrapperContBtnDs}>
          ...
          <img src={ggenius} alt="" className={style.homeWrapperImg} />
        </div>
      </div>
    </section>
