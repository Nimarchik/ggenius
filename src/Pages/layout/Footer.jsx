            ...
            <div className={style.footerWrapperLogoGroup}>
              ...
              <ul className={style.footerWrapperLogoGroupList}>
                <li className={style.footerWrapperLogoGroupListItem}>
                  <Link to='https://t.me/ggenius_gg' className={style.footerWrapperLogoGroupListItemLink}>
                ...
                <li className={style.footerWrapperLogoGroupListItem}>
                  <Link to='https://discord.gg/8Ydy3dHaqV' className={style.footerWrapperLogoGroupListItemLink}>
                ...
                <li className={style.footerWrapperLogoGroupListItem}>
                  <Link to='mailto:mlbb.boss.ua@gmail.com' className={style.footerWrapperLogoGroupListItemLink}>
